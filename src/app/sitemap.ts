...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: absoluteUrl("/guides/is-ikfw-genuine"), changeFrequency: "monthly", priority: 0.85 },
    { url: absoluteUrl("/guides/ikfw-auditions-and-fees"), changeFrequency: "monthly", priority: 0.85 },
